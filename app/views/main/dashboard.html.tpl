...
<HTML>
	...
	<BODY>
		<DIV class="dash_side">
			...
			<DIV class="dash_button">
				<IMG src="data:image/svg+xml;charset=utf8,%3Csvg%20viewBox='0%200%2030%2030'%20xmlns='http://www.w3.org/2000/svg'%3E%3Cpath%20fill='%23fff'%20d='M7%205H6a1%201%200%200%200-1%201h3a1%201%200%200%200-1-1z'/%3E%3Ccircle%20fill='#fff'%20cx='15'%20cy='15'%20r='5'/%3E%3Cpath%20fill='#fff'%20d='M26%207h-4.264a2%202%200%200%201-1.789-1.106l-.394-.789A2.002%202.002%200%200%200%2017.764%204h-5.528a2%202%200%200%200-1.789%201.106l-.394.789A2.002%202.002%200%200%201%208.264%207H4a2%202%200%200%200-2%202v13a2%202%200%200%200%202%202h22a2%202%200%200%200%202-2V9a2%202%200%200%200-2-2zM15%2022c-3.86%200-7-3.14-7-7s3.14-7%207-7%207%203.14%207%207-3.14%207-7%207zm9-11a1%201%200%201%201%200-2%201%201%200%200%201%200%202z'/%3E%3C/svg%3E">
